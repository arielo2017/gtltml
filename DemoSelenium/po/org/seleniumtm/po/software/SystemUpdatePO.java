...
public class SystemUpdatePO {
	...
	public SystemUpdatePO(WebDriver driver) {
		this.driver = driver;
	...
	public void createSystemUpdate(String name, String filezip, String descrp,
		...
		esperarElemento(driver.findElement(By.cssSelector("[ng-click='vm.goToAddObject()']")));
		try {
			Thread.sleep(10000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
		driver.findElement(By.cssSelector("[ng-click='vm.goToAddObject()']")).click();
